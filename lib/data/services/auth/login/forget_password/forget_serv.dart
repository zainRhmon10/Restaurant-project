...
import 'package:flutter_application_restaurant/data/model/auth/login/forget_password/forget_model.dart';
...
class ForgetServ{
  ...
  try {
    final response = await http.post(
      Uri.parse("http://127.0.0.1:8000/api/passwords/email"),
      headers: {
