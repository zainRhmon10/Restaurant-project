...
import 'package:flutter_application_restaurant/data/services/auth/login/forget_password/verify_serv.dart';
...
class Otp_verify extends StatelessWidget {
  ...
  LoginControllerImp cont =Get.find();
  @override
    ...
    return  OtpTextField(
      ...
      onSubmit: (String verificationCode)async{
        if(cont.formstate.currentState!.validate()){
          bool success = await VerifyServ.verify(cont.email.text,verificationCode);
                      if (success) {
